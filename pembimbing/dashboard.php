...
// Ambil daftar peserta bimbingan berdasarkan kecocokan nama pembimbing
$stmt = $pdo->prepare("
        ...
        <div class="flex-1 overflow-y-auto p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-blue-500">
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?= $total_peserta ?></p>
                </div>
            </div>

            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100 bg-gray-50">
                    <h2 class="text-lg font-bold text-gray-800">Daftar Peserta Magang di Bawah Bimbingan Anda</h2>
                </div>
                    ...
                    <table class="w-full text-left text-sm border-collapse">
                        ...
                        <tbody>
                            <?php if (count($peserta_bimbingan) > 0): ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="5" class="p-8 text-center text-gray-500">Belum ada peserta yang ditempatkan dengan nama pembimbing Anda.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
